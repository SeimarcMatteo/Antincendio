...
<head>
    ...
    <style>
        ...
        header { border-bottom: 2px solid #b30000; margin-bottom: 16px; padding-bottom: 10px; }
        ...
        .note { border: 1px solid #ddd; padding: 10px; background-color: #fcfcfc; page-break-inside: avoid; }
